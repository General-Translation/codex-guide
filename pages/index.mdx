...
| <PromptButtonSVG /> | Enables input of natural language prompts for dynamic modifications to both input and translation outputs. | [Prompting](https://guide.codex.ai/tools/prompting) |
