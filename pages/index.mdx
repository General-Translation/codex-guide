...
| <BookButtonSVG /> | Opens the interface to add, delete, or navigate through pages within a translation. | [Pages](https://guide.codex.ai/tools/pages) |
| <LayerButtonSVG /> | Splits content that is too long into multiple pages. | [Paginate](https://guide.codex.ai/tools/pages#paginate) |
