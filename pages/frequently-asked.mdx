...
Absolutely not. Our agreements with our model providers that strictly forbid them from using any of your data to train their models. We make sure your input stays your own, no strings attached.
...
If you have any other questions that aren't answered here, feel free to [send us an email](mailto:archie@generaltranslation.com?subject=Codex)!